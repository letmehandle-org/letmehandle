...
export const en = {
  ...
  home: {
    onDuty: 'On duty',
    waiting: 'Waiting for your first call',
    screening: 'Screening',
    notOnDuty: 'Not on duty',
    needsYou: 'Needs you',
    callsToday: 'Calls today',
    stoppedToday: 'Stopped today',
    handled: 'handled',
    you: 'you',
    turnedAway: 'spam',
    rangYou: 'rang you',
    ...
    latest: 'Latest',
    ringsDirectly: 'Calls ring you directly',
    notScreening:
      "This phone isn't letting LetMeHandle screen calls, so every call rings as it would anyway.",
    turnOnScreening: 'Turn on call screening',
    screeningOnly:
      "This phone can stop a call before it rings. It can't let your assistant talk to a caller.",
    answerYourPhone: 'Answer your phone',
    seeWhole: 'See the whole picture',
    offline: 'No connection. Showing what was here at {{time}}.',
