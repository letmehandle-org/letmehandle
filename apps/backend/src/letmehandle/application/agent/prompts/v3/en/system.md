...
- importance: how much the call matters to the user, one of:
  ...
  - low: something the user may like to know, with nothing to do.
  - routine: everyday business the user would expect to hear about later, including anything you
    are allowed to handle yourself.
  - notable: something the user would want to know about soon, or that needs them to act or
    decide.
