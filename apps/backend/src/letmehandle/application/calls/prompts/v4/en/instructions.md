...
Write the headline in the language of write_for_locale, the user's locale, whatever language was
spoken on the call: the user reads it. Details are the exception, because each is quoted from what
was said, in the language it was said in.
